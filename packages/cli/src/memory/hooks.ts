...
/** @deprecated Use buildClaudeCaptureHooksOperation — kept name for call-site migration */
export const buildClaudeHooksOperation = buildClaudeCaptureHooksOperation
