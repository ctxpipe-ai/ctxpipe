...
- **Commit and share**: include `.ai/memory/` changes in the commit for the work they came from, on that branch; summarise the work in the PR description. Merged lessons become graph instructions ([ADR-037](.ai/memory/decisions/ADR-037-committed-memory-reaches-the-graph.md)).
