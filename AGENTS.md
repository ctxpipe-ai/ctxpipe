...
When `ctx_advisor` answers **Human decision needed**, ask the user before building on a choice: they decide now, or you write a proposed ADR (`Status: Proposed`) for the owner.
