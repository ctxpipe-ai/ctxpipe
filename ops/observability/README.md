...
6. Create a DNS CNAME for `telemetry.ctxpipe.ai` to the value in `terraform output collector_dns_record`. Until that is live, use the Railway service domain `ctxpipe-telemetry.up.railway.app`.
