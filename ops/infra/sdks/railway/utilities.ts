...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3RlcnJhZm9ybS1jb21tdW5pdHktcHJvdmlkZXJzL3JhaWx3YXkiLCJ2ZXJzaW9uIjoiMC42LjEifX0="), c => c.charCodeAt(0)));
