...
**Ops vs chat:** folder-map ops is a write-path **job**, not product chat. It uses the Workspace **write sandbox** ([Ingest-to-git write and concurrency protocol](10-ingest-to-git-write-protocol.md)). That supersedes the earlier unsandboxed-ops line and does not reopen DIY OpenCode.
