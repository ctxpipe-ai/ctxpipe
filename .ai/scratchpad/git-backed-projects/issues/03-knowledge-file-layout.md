...
- Where the **linked-repo list** lives (root map front matter vs `repositories.md` vs `.gitmodules`) — only after [Git-canonical knowledge and deterministic hydrate](02-hydration-contract.md) locks “list of URLs” vs submodules/vendor.
