...
| Path identity | The canonical identity of a git-backed knowledge unit is its path in the backing tree. A move or rename is a new identity. Serving-store ids are derived from Project + path. |
