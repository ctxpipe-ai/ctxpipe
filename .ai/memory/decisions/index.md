...
| [ADR-033](ADR-033-native-durable-write-workflows.md) | Native durable writes, current ingestion ownership, immutable source indexes and scope-fenced connector results | Accepted |
