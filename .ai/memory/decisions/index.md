...
| [ADR-034](ADR-034-native-postgres-sandbox-ownership.md) | Native Postgres sandbox ownership, shared bases, live revisions and native process/resource enforcement | Accepted design; Gate 4 in progress |
