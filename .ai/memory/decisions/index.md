...
| [ADR-033](ADR-033-native-durable-write-workflows.md) | Native durable writes, paused execution, scope-fenced connector children and result projections | Accepted |
