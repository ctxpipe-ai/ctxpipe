...
| [ADR-034](ADR-034-native-postgres-sandbox-ownership.md) | Native Postgres sandbox ownership, shared bases, live revisions, native process/resource enforcement and remote TLS runner | Accepted design; Gate 4 in progress |
