...
| [ADR-034](ADR-034-native-postgres-sandbox-ownership.md) | Native Postgres sandbox ownership, shared bases, live revisions, native stream/process/resource enforcement, provider eligibility, remote TLS runner and opt-in native egress | Accepted design; Gate 4 in progress |
