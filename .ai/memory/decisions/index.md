...
| [ADR-033](ADR-033-native-durable-write-workflows.md) | Native durable writes, current ingestion ownership, scope-fenced connector children and result projections | Accepted |
