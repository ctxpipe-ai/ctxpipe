...
/**
 * Runtime processes (backend, worker) must connect as a LOGIN role that
 * cannot bypass RLS. Owner URLs (`neondb_owner`, Compose `ctxpipe`, Aurora
 * master) inherit BYPASSRLS — ENABLE-only policies would be theater.
 */
