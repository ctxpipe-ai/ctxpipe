...
export const notionSyncTargets = pgTable(
  "notion_sync_targets",
  {
  ...
  (t) => [
    uniqueIndex("notion_sync_targets_connection_id_uq").on(t.connectionId),
    index("notion_sync_targets_repository_id_idx").on(t.repositoryId),
  ],
)
