...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "src/models/{notion-connector,pagerduty-connector,repositories}.test.ts",
      "src/routes/v1/connectors-{atlassian,linear,notion,pagerduty,slack}.test.ts",
      "src/routes/webhooks/{atlassian,linear,notion,pagerduty,slack}/*.test.ts",
      "src/routes/webhooks/github/github.test.ts",
      "src/routes/webhooks/github/github-{confluence,linear,notion,pagerduty}-push.test.ts",
