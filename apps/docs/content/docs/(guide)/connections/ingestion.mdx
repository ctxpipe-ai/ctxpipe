...
A separate **code ingestion** graph analyses the tree with LLM-assisted
...
backed by an OpenCypher-compatible engine (see [Graph databases](/docs/self-hosting/graph-databases)).
