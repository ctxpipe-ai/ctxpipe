...
your organisation and triggers **ingestion workflows** (OpenWorkflow) that:
...
worker, Postgres, and graph DB. See [Self hosting](/docs/self-hosting) for
compose profiles, env vars, and operations.
