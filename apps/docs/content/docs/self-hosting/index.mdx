---
title: Self-hosting
description: Run ctx| on your own infrastructure with Docker Compose, AWS CDK, or Railway.
---
...
<Cards>
  ...
  <Card title="AWS CDK" href="/docs/self-hosting/aws-cdk" description="Deploy ctx| on AWS with the CtxPipe construct." />
