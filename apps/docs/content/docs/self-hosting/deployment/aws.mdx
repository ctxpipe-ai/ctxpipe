...
together. The construct stores them in Secrets Manager and injects them into
the required ECS tasks. See [Self-host Slack](/docs/self-hosting/slack) for the
Slack app callback, event, scope, and distribution settings.
