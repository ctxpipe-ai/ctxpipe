      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-4xl items-center justify-center px-6 py-16 text-center">
        <section className="w-full max-w-3xl">
          ...
          >
            ...
            >
              ctx| is the self-learning context layer for autonomous AI agent fleets for engineering orgs,
          ...
          >
            ...
            >
              <div key={`${carouselPage}-${slideKey}`}>
                <h2
                  className="onb-in-1 mb-4 text-3xl font-semibold text-zinc-100 sm:text-4xl"
                >
                    ...
                    >
                      <defs>
                        ...
                        <marker
                          ...
                          markerUnits="strokeWidth"
                        >
                          <path d="M0,0 L6,3 L0,6 z" fill="rgb(161 161 170)" />
                        </marker>
                      </defs>
