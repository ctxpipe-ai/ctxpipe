    ...
    <div className="flex min-h-screen bg-[#0b0b0c] text-zinc-100">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-14 items-center gap-3 border-b border-zinc-800 px-5">
          ...
          {selected?.readonly ? (
            <span
              ...
              className="rounded-full border border-amber-700/70 px-2 py-0.5 text-[11px] text-amber-300"
            >
              Read-only
            </span>
          ) : null}
        ...
        <div className="flex min-h-0 flex-1">
          ...
          <aside className="flex w-[24rem] shrink-0 flex-col border-l border-zinc-800">
